...
!(function () {
   ...
   (window.MaterialLayout = f),
      ...
      (f.prototype.screenSizeHandler_ = function () {
         this.screenSizeMediaQuery_.matches
            ...
            : (this.element_.classList.remove(this.CssClasses_.IS_SMALL_SCREEN),
              this.drawer_ &&
                 (this.drawer_.classList.remove(this.CssClasses_.IS_DRAWER_OPEN), this.obfuscator_.classList.remove(this.CssClasses_.IS_DRAWER_OPEN)));
      }),
      ...
      (f.prototype.headerClickHandler_ = function () {
         this.header_.classList.contains(this.CssClasses_.IS_COMPACT) &&
            (this.header_.classList.remove(this.CssClasses_.IS_COMPACT), this.header_.classList.add(this.CssClasses_.IS_ANIMATING));
      }),
      ...
      (f.prototype.init = function () {
         if (this.element_) {
            ...
            if (
               (this.header_ &&
                  ...
                  o === this.Mode_.STANDARD
                     ...
                     : o === this.Mode_.WATERFALL &&
                       (this.content_.addEventListener("scroll", this.contentScrollHandler_.bind(this)), this.contentScrollHandler_())),
               this.drawer_)
            ) {
            ...
            if (
               ...
               for (
                  var L = this.tabBar_.querySelectorAll("." + this.CssClasses_.TAB), I = this.content_.querySelectorAll("." + this.CssClasses_.PANEL), f = 0;
                  f < L.length;
                  f++
               )
                  new t(L[f], L, I, this);
   ...
   (window.MaterialDataTable = b),
      ...
      (b.prototype.createCheckbox_ = function (e, t) {
         ...
         return (
            ...
            e
               ? ((a.checked = e.classList.contains(this.CssClasses_.IS_SELECTED)), a.addEventListener("change", this.selectRow_(a, e)))
